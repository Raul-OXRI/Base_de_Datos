# Generated by Django 4.2.6 on 2023-10-21 01:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Encargado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Biblioteca.encargado')),
            ],
            options={
